...
public static class CountAndExist
{
    ...
    public static int Count<E>(this ICaptureCommandParameter capture, BasicList<ICondition> conditions, IDbTransaction? thisTran = null, int? connectionTimeOut = null) where E : class, ISimpleDapperEntity
    {
    ...
    public static int Count<E>(this ICaptureCommandParameter capture, IDbTransaction? thisTran = null, int? connectionTimeOut = null) where E : class, ISimpleDapperEntity
    {
        EnumDatabaseCategory database = capture.Category;
        SourceGeneratedMap map = GetMap<E>();
    ...
    public static bool Exists<E>(this ICaptureCommandParameter capture, BasicList<ICondition> conditions, IDbTransaction? thisTran = null, int? connectionTimeOut = null) where E : class, ISimpleDapperEntity
    {
        EnumDatabaseCategory database = capture.Category;
        SourceGeneratedMap map = GetMap<E>();
