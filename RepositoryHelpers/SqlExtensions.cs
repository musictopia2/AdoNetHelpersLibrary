...
public static class SqlExtensions
{
    ...
    /// </summary>
    /// <param name="services">The service collection where the repositories will be registered.</param>
    ...
    public static IServiceCollection AddDatabaseRepositories<T>(
    ...
    /// <returns>The updated service collection.</returns>
    public static IServiceCollection AddDatabaseRepositories<T, U>(
        this IServiceCollection services,
        Action<DatabaseRepositoryRegistrationContext> entityConfigurator)
