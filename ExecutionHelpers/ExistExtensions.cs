...
internal static class ExistExtensions
{
    ...
    {
        public bool Exists(CompleteSqlData complete, IDbTransaction? transaction = null, int? commandTimeout = null)
        {
            return capture.Exists(complete.SQLStatement, complete.Parameters, transaction, commandTimeout, null);
        }
        public bool Exists(string sql, BasicList<DynamicParameter>? param = null, IDbTransaction? transaction = null, int? commandTimeout = null, CommandType? commandType = null)
        {
        ...
        public bool Exists(CommandDefinition command)
        {
            bool isClosed;
